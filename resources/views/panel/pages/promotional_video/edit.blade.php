    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-2">
            <div class="row y-gap-20 justify-between items-end pb-30 lg:pb-40 md:pb-32">
                <div class="col-12">
                    <h1 class="text-30 lh-14 fw-600">Ubah Video Promosi</h1>
                    <div class="text-15 text-light-1">Ubah Video Promosi Blessing89 Tour & travel</div>
                </div>
            </div>
            <div class="py-30 px-30 rounded-4 bg-white shadow-3">
                <div class="tabs -underline-2 js-tabs">
                    <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls" style="min-height:300px">
                        <form class="forms-sample" action="{{ route('admin-panel.promotional_video.update', $promotional_video->id) }}"
                            ...
                            <div class="row mb-5">
                                <div class="col-12 col-lg-6 mb-3">
                                    ...
                                    <input type="file" id="path_video" name="path_video"
                                        ...
                                        <span class="fw-700">File Video Promosi :</span> <a
                                        href="/assets/video/{{ $promotional_video->path_video }}">Link Video Promosi</a>
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    ...
                                    <select class="form-control form-control-lg h-50" name="is_show" id="is_show">
                                        <option value="{{ $promotional_video->is_show }}" disabled selected>
