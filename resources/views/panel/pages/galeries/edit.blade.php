    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-2">
            ...
            <div class="py-30 px-30 rounded-4 bg-white shadow-3">
                ...
                <form action="{{ route('admin-panel.galeri.update', $galeri->id) }}" method="POST"
                    ...
                    <div class="col-xl-10">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mt-15">
                                    <input type="file" name="path_items" class="form-control">
                                </div>
                                <div><a class="btn btn-secondary mt-15" href="/{{ $galeri->path_items }}">Lihat Item Sekarang</a></div>
                            </div>
                            <div class="col-md-6">
                                <div class="fw-500">Jenis Item yang Diupload</div>
                                <div class="mt-15">
                                    <select name="jenis_items" id="jenis_items" class="form-control">
                                        <option value="" selected disabled>{{ $galeri->jenis_items }}</option>
