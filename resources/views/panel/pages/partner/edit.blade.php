    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-2">
            <div class="row y-gap-20 justify-between items-end pb-30 lg:pb-40 md:pb-32">
                <div class="col-12">
                    <h1 class="text-30 lh-14 fw-600">Ubah Partner</h1>
                    <div class="text-15 text-light-1">Ubah Partner Blessing89 Tour & travel</div>
                </div>
            </div>
            <div class="py-30 px-30 rounded-4 bg-white shadow-3">
                <div class="tabs -underline-2 js-tabs">
                    <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls" style="min-height:300px">
                        <form class="forms-sample" action="{{ route('admin-panel.partner.update', $partner->id) }}"
                            ...
                            <div class="row mb-5">
                                <div class="col-12 col-lg-6 mb-3">
                                    ...
                                    <input type="text" id="name" name="name"
                                        ...
                                        placeholder="Contoh: Tour Sumatera" value="{{ $partner->name }}">
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="website_url" class="mb-2">Link Website Partner</label>
                                    <input type="text" id="website_url" name="website_url"
                                        class="form-control form-control-lg h-50 @error('name') is-invalid @enderror"
                                        placeholder="Contoh: Tour Sumatera" value="{{ $partner->website_url }}">
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    ...
                                    <input type="file" id="logo_path" name="logo_path"
                                        class="pt-15 form-control form-control-lg h-50 @error('name') is-invalid @enderror"
                                        placeholder="Contoh: Deluxe, dll" value="{{ old('logo_path') }}">
                                </div>
                                <div class="col-12 col-lg-12 mb-3">
                                    <label for="description" class="mb-2">Detail Partner</label>
                                    <textarea class="form-control form-control-md" name="description" id="description" rows="3">{!! $partner->description !!}</textarea>
                                </div>
                            </div>
