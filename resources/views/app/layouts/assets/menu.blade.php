    ...
    <div class="col-12">
      <div class="tabs -bookmark-2 js-tabs">
        ...
        <div class="tabs__content js-tabs-content">
          ...
          <div class="tabs__pane -tab-item-2 {{ $currentRoute === 'frontend.products.layanan' ? 'is-tab-el-active' : '' }}"></div>
          <div class="tabs__pane -tab-item-3 {{ $currentRoute === 'frontend.testimoni' ? 'is-tab-el-active' : '' }}"></div>
          <div class="tabs__pane -tab-item-4 {{ $currentRoute === 'frontend.galeri' ? 'is-tab-el-active' : '' }}"></div>
          <div class="tabs__pane -tab-item-5 {{ $currentRoute === 'frontend.tentang' ? 'is-tab-el-active' : '' }}"></div>
          <div class="tabs__pane -tab-item-6 {{ $currentRoute === 'frontend.kontak' ? 'is-tab-el-active' : '' }}"></div>
          <div class="tabs__pane -tab-item-7 {{ $currentRoute === 'frontend.panduan' ? 'is-tab-el-active' : '' }}"></div>
        </div>
      </div>
    </div>
  </div>
