    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-2" style="font-family: var(--font-primary);">
            <div class="row y-gap-20 justify-between items-end pb-30 lg:pb-40 md:pb-32">
                <div class="col-12">
                    <h1 class="text-30 lh-14 fw-600">Kelola Video Promosi</h1>
                    <div class="text-15 text-light-1">Kelola Video Promosi Blessing89 Tour & travel</div>
                </div>
                <div class="col-md-12">
                    <a href="/admin-panel/promotional_video/create" class="btn btn-primary btn-lg">
                        <i class="fa-solid fa-plus"></i> Tambah Video Promosi
                    </a>
                </div>
            </div>
            ...
            <div class="py-30 px-30 rounded-4 bg-white shadow-3 col-12" style="place-self: anchor-center;">
                <div class="tabs -underline-2 js-tabs">
                    <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls" style="min-height:300px">
                        <table class="table table-3-border-bottom col-12" id="table-promotional-video">
                            <thead class="bg-light-2">
                                <tr>
                                    <th class="text-center" style="font-weight: bold">Video Promosi</th>
                                    <th class="text-center" style="font-weight: bold">Status Tampil</th>
                                    <th class="text-center" style="font-weight: bold">Status Tampil</th>
                                ...
                                @foreach ($promotional_videos as $promotional_video)
                                    <tr>
                                        <td class="text-center"><a
                                                href="/assets/video/{{ $promotional_video->path_video }}">{{ $promotional_video->path_video }}</a>
                                        </td>
                                        <td>
                                        ...
                                        <td class="action">
                                            <div class="row x-gap-10 y-gap-10 items-center" style="justify-content: center">
                                                {{-- Tombol Detail --}}
                                                <div class="col-auto">
                                                    <a href="{{ route('admin-panel.promotional_video.show', $promotional_video->id) }}"
                                                ...
                                                {{-- Tombol Edit --}}
                                                <div class="col-auto">
                                                    <a href="{{ route('admin-panel.promotional_video.edit', $promotional_video->id) }}"
        ...
        function deleteConfirmation(button) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/admin-panel/promotional_video/delete/' + kode;
                }
            });
        }
        var table = $('#table-promotional-video').DataTable({
            "pageLength": 5,
