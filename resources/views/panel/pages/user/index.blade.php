    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-2" style="font-family: var(--font-primary);">
            <div class="row y-gap-20 justify-between items-end pb-30 lg:pb-40 md:pb-32">
                <div class="col-12">
                    <h1 class="text-30 lh-14 fw-600">Kelola Pengguna</h1>
                    <div class="text-15 text-light-1">Kelola Pengguna Blessing89 Tour & travel</div>
                </div>
                <div class="col-md-12">
                    <a href="/admin-panel/user/create" class="btn btn-primary btn-lg">
            ...
            <div class="py-30 px-30 rounded-4 bg-white shadow-3 col-9" style="place-self: anchor-center;">
                <div class="tabs -underline-2 js-tabs">
                    <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls" style="min-height:300px">
                        <table class="table table-3-border-bottom col-12" id="table-user">
                            <thead class="bg-light-2">
                                <tr>
                                    <th class="text-center" style="font-weight: bold">Nama Pengguna</th>
        ...
        function deleteConfirmation(button) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/admin-panel/user/delete/' + kode;
                }
            });
        }
