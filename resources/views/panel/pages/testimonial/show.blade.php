                            ...
                            <div class="row mb-5">
                                <div class="col-12 col-lg-12 mb-3">
                                    ...
                                    <input type="text" id="customer_name" name="customer_name"
                                        ...
                                        placeholder="Contoh: Tour Sumatera" value="{{ $testimonial->customer_name }}" readonly>
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="customer_photo_path" class="mb-2">Foto Pelanggan</label><br>
                                    <img src="/uploads/testimonial/{{ $testimonial->customer_photo_path }}" alt="">
                                </div>
                                <div class="col-12 col-lg-12 mb-3">
                                    <label for="testimonial_text" class="mb-2">Isi Testimonial</label>
                                    <span>{!! $testimonial->testimonial_text !!}</span>
                                </div>
                            </div>
                            <a href="{{ route('admin-panel.testimonial.index') }}" class="btn btn-light">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
