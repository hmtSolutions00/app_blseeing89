    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-2">
            <div class="row y-gap-20 justify-between items-end pb-30 lg:pb-40 md:pb-32">
                <div class="col-12">
                    <h1 class="text-30 lh-14 fw-600">Tambah Testimonial</h1>
                    <div class="text-15 text-light-1">Tambah Testimonial Blessing89 Tour & travel</div>
                </div>
            </div>
            <div class="py-30 px-30 rounded-4 bg-white shadow-3">
                <div class="tabs -underline-2 js-tabs">
                    <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls" style="min-height:300px">
                        <form class="forms-sample" action="{{ route('admin-panel.testimonial.store') }}"
                            ...
                            <div class="row mb-5">
                                <div class="col-12 col-lg-6 mb-3">
                                    ...
                                    <input type="text" id="customer_name" name="customer_name"
                                        ...
                                        placeholder="Contoh: Tour Sumatera" value="{{ old('customer_name') }}">
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="customer_photo_path" class="mb-2">Foto Pengguna</label>
                                ...
                                <div class="col-12 col-lg-12 mb-3">
                                    ...
                                    <textarea class="form-control form-control-md" name="testimonial_text" id="testimonial_text" rows="3"></textarea>
                                </div>
                            </div>
