    ...
    <div class="dashboard__main">
        <div class="dashboard__content bg-light-2">
            <div class="row y-gap-20 justify-between items-end pb-30 lg:pb-40 md:pb-32">
                <div class="col-12">
                    <h1 class="text-30 lh-14 fw-600">Tambah Pengguna</h1>
                    <div class="text-15 text-light-1">Tambah Pengguna Blessing89 Tour & travel</div>
                </div>
            </div>
            <div class="py-30 px-30 rounded-4 bg-white shadow-3">
                <div class="tabs -underline-2 js-tabs">
                    <div class="tabs__controls row x-gap-40 y-gap-10 lg:x-gap-20 js-tabs-controls" style="min-height:300px">
                        <form class="forms-sample" action="{{ route('admin-panel.user.store') }}"
                            ...
                            <div class="row mb-5">
                                <div class="col-12 col-lg-6 mb-3">
                                    ...
                                    <input type="text" id="name" name="name"
                                        ...
                                        placeholder="Contoh: Admin" value="{{ old('name') }}">
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
                                    <label for="email" class="mb-2">Email</label>
                                    <input type="email" id="email" name="email"
                                        class="form-control form-control-lg h-50 @error('name') is-invalid @enderror"
                                        placeholder="Contoh: admin@gmail.com" value="{{ old('email') }}">
                                </div>
                                <div class="col-12 col-lg-6 mb-3">
